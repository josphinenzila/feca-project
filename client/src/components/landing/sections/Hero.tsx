        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
              Building <span className="text-emerald-600">Peaceful</span>{" "}
              Communities Through{" "}
              <span className="text-blue-600">Civic Action</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              FECA empowers marginalized voices to ignite civic transformation
              through inclusive governance, digital democracy, and sustainable
              livelihoods.
            </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">Years Impact</p>
                </div>
              </div>
            </div>
          </div>
